...
const SOCIAL_LINKS = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/ekemini.eshiet.75?stkn=MXIzeGttZ3lnNnV6ag%3D%3D&utm_source=qr',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/share/19dppmqLWE/?mibextid=wwXIfr',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    name: 'X (Twitter)',
    href: 'https://x.com/ekemini58110?s=11',
    icon: (
